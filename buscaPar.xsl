...
<xsl:template match="par">
  ...
  <xsl:text disable-output-escaping="yes"><![CDATA[" prm2="]]></xsl:text>
  <xsl:value-of select="@prm2"/> 
  <xsl:text disable-output-escaping="yes"><![CDATA[" prm3="]]></xsl:text>
  <xsl:value-of select="@prm3"/> 
  <xsl:text disable-output-escaping="yes"><![CDATA[" prm4="]]></xsl:text>
  <xsl:value-of select="@prm4"/> 
  <xsl:text disable-output-escaping="yes"><![CDATA[" prm5="]]></xsl:text>
